...
var muteli = "728569696248660010"; //buraya muteli rolünün id'sini koyunuz
var muteyetkisi = "746366826371612783"; // buraya mute yetkis irolünün id yazınız.
      ...
      if (
        ...
        if (!mutezaman) {
          ...
          let log = msg.guild.channels.find(c =>
            c.id.toLowerCase().includes("755373757639557141") //  
          );
          let vakit = mutezaman
            .replace("m", " dakika")
            .replace("s", " saniye")
